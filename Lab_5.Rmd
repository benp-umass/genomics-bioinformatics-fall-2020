...
```{r}
Confirmed_3_9_joined <- full_join(Confirmed_3_13, Confirmed_9_13, by = c("Country_Region")) %>% 
  rename(Confirmed_March = "Confirmed.x", Deaths_March = "Deaths.x", Confirmed_Sep = "Confirmed.y", Deaths_Sep = "Deaths.y")
datatable(Confirmed_3_9_joined)
```

3. applies to bar plot from 2.
